        ...
        members: [
            ...
            sorted(memberArray('Region Data Entries', 
                sortKey([0], memberStruct('Region Data Entry', [
                    ...
                    subrecord('RDMD', format(conflictType('Ignore', uint32('Music Type')), def('MusicEnum'))),
                    subrecord('RDMO', ckFormId('Music', ['MUSC'])),
                    subrecord('RDSI', ckFormId('Incidental MediaSet', ['MSET'])),
                    memberArray('Battle MediaSets', 
                        subrecord('RDSB', ckFormId('Battle MediaSet', ['MSET']))
                    ),
                    ...
                    subrecord('RDID', sorted(array('Imposters', 
                        ckFormId('Imposter', ['REFR'])
                    )))
                ]))
            ))
        ]
