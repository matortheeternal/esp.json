...
module.exports = () => {
    record('WTHR', 'Weather', {
        ...
        members: [
            ...
            subrecord('\x300TX', string('Cloud Texture Layer #1')),
            subrecord('\x300TX', string('Cloud Texture Layer #2')),
            subrecord('\x300TX', string('Cloud Texture Layer #3')),
            subrecord('\x300TX', string('Cloud Texture Layer #4')),
            subrecord('\x300TX', string('Cloud Texture Layer #5')),
            subrecord('\x300TX', string('Cloud Texture Layer #6')),
            subrecord('\x300TX', string('Cloud Texture Layer #7')),
            subrecord('\x300TX', string('Cloud Texture Layer #8')),
            subrecord('\x300TX', string('Cloud Texture Layer #9')),
