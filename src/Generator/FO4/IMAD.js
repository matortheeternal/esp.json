let {
    ...
    struct, unknown, subrecord, array, memberStruct, 
    record
} = require('../helpers');
...
module.exports = () => {
    record('IMAD', 'Image Space Adapter', {
        members: [
            ...
            memberStruct('Radial Blur', [
                subrecord('RNAM', array('Strength', 
                    def('TimeInterpolator')
                )),
                subrecord('SNAM', array('RampUp', 
                    def('TimeInterpolator')
                )),
                subrecord('UNAM', array('Start', 
                    def('TimeInterpolator')
                )),
                subrecord('NAM1', array('RampDown', 
                    def('TimeInterpolator')
                )),
                subrecord('NAM2', array('DownStart', 
                    def('TimeInterpolator')
                ))
            ]),
            memberStruct('Depth of Field', [
                subrecord('WNAM', array('Strength', 
                    def('TimeInterpolator')
                )),
                subrecord('XNAM', array('Distance', 
                    def('TimeInterpolator')
                )),
                subrecord('YNAM', array('Range', 
                    def('TimeInterpolator')
                )),
                subrecord('NAM5', array('Vignette Radius', 
                    def('TimeInterpolator')
                )),
                subrecord('NAM6', array('Vignette Strength', 
                    def('TimeInterpolator')
                ))
            ]),
