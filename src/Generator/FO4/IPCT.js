...
module.exports = () => {
    record('IPCT', 'Impact', {
        members: [
            ...
            subrecord('SNAM', ckFormId('Sound 1', ['SNDR'])),
            subrecord('NAM1', ckFormId('Sound 2', ['SNDR'])),
            subrecord('NAM3', ckFormId('Footstep Explosion', ['EXPL'])),
            subrecord('NAM2', ckFormId('Hazard', ['HAZD'])),
            subrecord('FNAM', float('Footstep Particle Max Dist'))
        ]
    })
};