let {
    ...
    float, array, unknown, memberStruct, memberArray, 
    enumeration, format, sortKey, sorted, localized, 
    string, conflictType, uint16, record
} = require('../helpers');
        ...
        members: [
            ...
            sorted(memberArray('Region Data Entries', 
                sortKey([0], memberStruct('Region Data Entry', [
                    ...
                    subrecord('RLDM', float('LOD Display Distance Multiplier')),
                    subrecord('ANAM', float('Occlusion Accuracy Dist'))
                ]))
            ))
        ]
    })
