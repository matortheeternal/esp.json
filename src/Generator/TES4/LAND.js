let {
    bytes, subrecord, uint8, struct, array, 
    count, float, size, ckFormId, def, 
    format, int16, sortKey, memberStruct, uint16, 
    sorted, memberUnion, memberArray, record
} = require('../helpers');

module.exports = () => {
    record('LAND', 'Landscape', {
        members: [
            subrecord('DATA', bytes('Unknown')),
