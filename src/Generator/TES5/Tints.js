...
module.exports = () => {
    addDef('Tints', arrayOfSubrecord('Tint Masks', multiStruct('Tint Assets', [
        arrayOfSubrecord('Tint Layer', multiStruct('Texture', [
        ...
        arrayOfSubrecord('Presets', multiStruct('Preset', [
