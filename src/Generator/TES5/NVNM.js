...
module.exports = () => {
    addDef('NVNM', subrecord('NVNM', struct('Geometry', [
        opts(uint32('Version'), {
        ...
        opts(array('Vertices', sortKey([0, 1, 2], struct('Vertex', [
            float('X'),
            float('Y'),
            float('Z')
        ])), -1), {
        ...
        opts(array('Triangles', struct('Triangle', [
        ...
        opts(array('Edge Links', struct('Edge Link', [
            bytes('Unknown', 4),
            ckFormId('Mesh', ['NAVM']),
            int16('Triangle')
        ]), -1), {
        ...
        array('Door Triangles', sortKey([0, 2], struct('Door Triangle', [
        ...
        opts(array('Cover Triangles', opts(int16('Triangle'), {
            "linksToCallback": "TriangleLinksTo"
        }), -1), {
            "includeFlag": "dfNotAlignable"
        }),
        ...
        float('Max Y'),
        float('Max Z'),
        opts(array('NavMeshGrid', opts(array('NavMeshGridCell', opts(int16('Triangle'), {
            "linksToCallback": "TriangleLinksTo"
        }), -1), {
            "includeFlag": "dfNotAlignable"
        })), {
