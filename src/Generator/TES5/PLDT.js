...
module.exports = () => {
    addDef('PLDT', subrecord('PLDT', struct('Location', [
        ...
        union('Location Value', [
            ...
            ckFormId('Object ID', ['NULL', 'ACTI', 'DOOR', 'STAT', 'MSTT', 'FURN', 'SPEL', 'SCRL', 'NPC_', 'CONT', 'ARMO', 'AMMO', 'MISC', 'WEAP', 'BOOK', 'KEYM', 'ALCH', 'LIGH', 'FACT', 'FLST', 'IDLM', 'SHOU']),
