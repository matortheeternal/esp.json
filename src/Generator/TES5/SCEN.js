...
module.exports = () => {
    record('SCEN', 'Scene', {
        members: [
            ...
            arrayOfSubrecord('Phases', multiStruct('Phase', [
            ...
            arrayOfSubrecord('Actors', multiStruct('Actor', [
            ...
            arrayOfSubrecord('Actions', multiStruct('Action', [
                ...
                arrayOfSubrecord('Packages', subrecord('PNAM', ckFormId('Package', ['PACK']))),
