    ...
    record('PACK', 'Package', {
        members: [
            ...
            multiStruct('Package Data', [
                arrayOfSubrecord('Data Input Values', req(multiStruct('Value', [
            ...
            multiStruct('Procedure Tree', [
                arrayOfSubrecord('Branches', req(multiStruct('Branch', [
                    ...
                    arrayOfSubrecord('Data Input Indexes', subrecord('PKC2', uint8('Index'))),
                    arrayOfSubrecord('Flags Override', subrecord('PFO2', struct('Data', [
                    ...
                    arrayOfSubrecord('Unknown', subrecord('PFOR', unknown()))
                ])))
            ]),
            def('UNAMs'),
            multiStruct('OnBegin', [
