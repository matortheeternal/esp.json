...
module.exports = () => {
    record('WTHR', 'Weather', {
        members: [
            def('EDID'),
            subrecord('\x000TX', string('Cloud Texture Layer #0')),
            subrecord('\x100TX', string('Cloud Texture Layer #1')),
            subrecord('\x200TX', string('Cloud Texture Layer #2')),
            subrecord('\x300TX', string('Cloud Texture Layer #3')),
            subrecord('\x400TX', string('Cloud Texture Layer #4')),
            subrecord('\x500TX', string('Cloud Texture Layer #5')),
            subrecord('\x600TX', string('Cloud Texture Layer #6')),
            subrecord('\x700TX', string('Cloud Texture Layer #7')),
            subrecord('\x800TX', string('Cloud Texture Layer #8')),
            subrecord('\x900TX', string('Cloud Texture Layer #9')),
