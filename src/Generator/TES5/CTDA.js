...
module.exports = () => {
    addDef('CTDA', sortKey([0], multiStruct('Condition', [
        subrecord('CTDA', sortKey([3, 5], struct('', [
            ...
            union('Parameter #1', [
                ...
                ckFormId('Referenceable Object', ['NULL', 'NPC_', 'PROJ', 'TREE', 'SOUN', 'ACTI', 'DOOR', 'STAT', 'FURN', 'CONT', 'ARMO', 'AMMO', 'MISC', 'WEAP', 'BOOK', 'KEYM', 'ALCH', 'LIGH', 'GRAS', 'ASPC', 'IDLM', 'ARMA', 'MSTT', 'TACT', 'LVLI', 'LVSP', 'SPEL', 'SCRL', 'SHOU', 'SLGM', 'ENCH', 'FLOR', 'FLST']),
