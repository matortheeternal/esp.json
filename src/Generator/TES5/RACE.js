        ...
        members: [
            ...
            req(multiStruct('Head Data', [
                ...
                req(multiStruct('Male Head Data', [
                    ...
                    def('Morphs'),
                    arrayOfSubrecord('Race Presets Male', subrecord('RPRM', ckFormId('Preset NPC', ['NPC_', 'NULL']))),
                    arrayOfSubrecord('Available Hair Colors Male', subrecord('AHCM', ckFormId('Hair Color', ['CLFM', 'NULL']))),
                    arrayOfSubrecord('Face Details Texture Set List Male', subrecord('FTSM', ckFormId('Texture Set', ['TXST', 'NULL']))),
                ...
                req(multiStruct('Female Head Data', [
                    ...
                    arrayOfSubrecord('Head Parts', def('HeadPart')),
                    def('Morphs'),
                    arrayOfSubrecord('Race Presets Female', subrecord('RPRF', ckFormId('Preset NPC', ['NPC_', 'NULL']))),
                    arrayOfSubrecord('Available Hair Colors Female', subrecord('AHCF', ckFormId('Hair Color', ['CLFM', 'NULL']))),
                    arrayOfSubrecord('Face Details Texture Set List Female', subrecord('FTSF', ckFormId('Texture Set', ['TXST', 'NULL']))),
