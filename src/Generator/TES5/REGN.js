...
module.exports = () => {
    record('REGN', 'Region', {
        ...
        members: [
            ...
            arrayOfSubrecord('Region Areas', multiStruct('Region Area', [
                subrecord('RPLI', uint32('Edge Fall-off')),
                subrecord('RPLD', array('Region Point List Data', struct('Point', [
                    float('X'),
                    float('Y')
                ])))
            ])),
            arrayOfSubrecord('Region Data Entries', sortKey([0], multiStruct('Region Data Entry', [
                ...
                subrecord('RDSA', array('Sounds', sortKey([0], struct('Sound', [
                ...
                subrecord('RDOT', array('Objects', struct('Object', [
                    ckFormId('Object', ['TREE', 'FLOR', 'STAT', 'LTEX', 'MSTT']),
                ...
                subrecord('RDGS', array('Grasses', sortKey([0], struct('Grass', [
                    ckFormId('Grass', ['GRAS']),
                    bytes('Unknown', 4)
                ])))),
                subrecord('RDWT', array('Weather Types', sortKey([0], struct('Weather Type', [
